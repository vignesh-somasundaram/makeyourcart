...
<%@ include file="commonFiles/navbar.jspf"%>
 ...
 <h2>Want to search for a specified set of products? Click <a href="/productspage">here</a></h2>
	 <form action="/findprodbyId" method=post modelAttribute="product">
	     <label  style="margin-left: 420px;">Enter product ID</label>
		 <input type="number" name="id" style="margin-left: 420px;width:300px;" required="required"/><br>
